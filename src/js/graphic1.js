...
function setupChart(){
        ...
        data.forEach(function(d){
            ...
            for (var i = 0; i < 3; i++){
                var subdata = [
                    {category: "filler0", value: d["mean_" + groups[i]] - d["sd_" + groups[i]]},
                    ...
                    {category: "filler2", value: 85 - d["mean_" + groups[i]] - d["sd_" + groups[i]] - 1},
        ...
        var color_old = d3.scaleOrdinal()
            ...
            .range(["#f2e5f2", "#cab2d6", "#6a3d9a", "#cab2d6", "#f6f6f6","#f6f6f6","none"]);

        var color_new = d3.scaleOrdinal()
            .domain([0,1,2,3,4,5,6])
            .range(["#ffedcc","#fdbf6f", "#ff7f00", "#fdbf6f", "#f6f6f6", "#f6f6f6","none"]);
        ...
        svg.append("path")
            .at("class", "walking-grade")
            .at("d", "M-8 -238 L-10 -238 L-10 -182 L-8 -182")
        ...
        svg.append("path")
            .at("class", "walking-grade")
            .at("d", "M-8 -178 L-10 -178 L-10 -122 L-8 -122")
        ...
        svg.append("path")
            .at("class", "walking-grade")
            .at("d", "M-8 -118 L-10 -118 L-10 -62 L-8 -62")
